...
/**
 	* A data access object (DAO) providing persistence and search support for Productline entities.
 	 		* Transaction control of the save(), update() and delete() operations must be handled externally by senders of these methods 
 		  or must be manually added to each of these methods for data to be persisted to the JPA datastore.	
 	 * @see my.group.entity.Productline
...
public class ProductlineDAO  {
	...
	private EntityManager getEntityManager() {
		...
		/**
	 Perform an initial save of a previously unsaved Productline entity. 
    ...
    public void save(Productline entity) {
    				EntityManagerHelper.log("saving Productline instance", Level.INFO, null);
	        try {
    ...
    /**
	 Delete a persistent Productline entity.
    ...
    public void delete(Productline entity) {
    				EntityManagerHelper.log("deleting Productline instance", Level.INFO, null);
	        try {
        	entity = getEntityManager().getReference(Productline.class, entity.getProductline());
    ...
    /**
	 Persist a previously saved Productline entity and return it or a copy of it to the sender. 
	 A copy of the Productline entity parameter is returned when the JPA persistence mechanism has not previously been tracking the updated entity. 
    ...
    public Productline update(Productline entity) {
    				EntityManagerHelper.log("updating Productline instance", Level.INFO, null);
	        try {
    ...
    public Productline findById( String id) {
    				EntityManagerHelper.log("finding Productline instance with id: " + id, Level.INFO, null);
	        try {
...
/**
    ...
    public List<Productline> findByProperty(String propertyName, final Object value
        ) {
    				EntityManagerHelper.log("finding Productline instance with property: " + propertyName + ", value: " + value, Level.INFO, null);
			try {
			final String queryString = "select model from Productline model where model." 
	...
	public List<Productline> findAll(
					...
					EntityManagerHelper.log("finding all Productline instances", Level.INFO, null);
			try {
