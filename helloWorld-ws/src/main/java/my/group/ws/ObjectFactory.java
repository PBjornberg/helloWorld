 ...
 * generated in the my.group.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _MultiplyResponse_QNAME = new QName("http://localhost/wsdl", "multiplyResponse");
    private final static QName _SumResponse_QNAME = new QName("http://localhost/wsdl", "sumResponse");
    private final static QName _Sum_QNAME = new QName("http://localhost/wsdl", "sum");
    private final static QName _Multiply_QNAME = new QName("http://localhost/wsdl", "multiply");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: my.group.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost/wsdl", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost/wsdl", name = "sumResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost/wsdl", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost/wsdl", name = "multiply")
